          ...
          >
            <Reveal effect="fadeInUp">
              <div className="bg-gray-800 rounded-lg shadow-lg p-6 text-white">
                <img
                  ...
                  alt=""
                />
                <h3 className="text-xl text-orange-200 font-semibold mb-2">
                  College
                </h3>
                <p className="text-gray-300 font-bold mb-4">Eco College</p>
                <p className="text-white">
                  My college, Eco College, is a top-ranked institution located
                  in the bustling city of Thakurgaon Bangladesh.i have completed
                  my college life in 2018.
                </p>
              </div>
            </Reveal>
            <Reveal effect="fadeInUp" delay={200}>
              <div className="bg-gray-800 rounded-lg shadow-lg p-6 text-white">
                ...
                <p className="text-white">
                  My University, Haldia Institute of Technology, is a top-ranked
                  institution located in the bustling Kolkata India.i have
                  completed my Versity life in 2023..
                </p>
              </div>
            </Reveal>
            <Reveal effect="fadeInUp" delay={400}>
              <div className="bg-gray-800 rounded-lg shadow-lg p-6 text-white">
                <img
                  className="rounded-xl h-56"
                  src="https://i.ibb.co/BGpP6MM/banner.png"
                  alt=""
                />
                <h3 className="text-xl font-semibold mb-2 text-orange-200">
                  Online Courses
                ...
                <p className="text-white">
                  Programming Hero One of the Best Online Course in Bangladesh
                  .this course duration was 6 months i have completed
                  programming hero course perfectly.
                </p>
              </div>
            </Reveal>
          </div>
